        ...
        function listar() {
            $.get("post", {"opc": 1}, function (data) {
                ...
                for (var i = 0; i < x.length; i++) {
                    $("#tablita").append(
                            "<tr><td>" + (i + 1) + "</td><td>" + x[i].idalumno + "</td><td>" + x[i].escuela
                            + "</td><td>" + x[i].nombres + "</td><td>" + x[i].correo + "</td><td>" + "</td><td><a href='#' onclick='editar("
                            + x[i].idalumno + ")'><i class='fa-solid fa-pen-to-square yelow'></i></a></td><td><a href='#' onclick='eliminar(" + x[i].idalumno + ")'><i class='fa-solid fa-trash-can red'></i></a></td></tr>");
                }
            });
        }
